      ...
      <div className="grid lg:grid-cols-2 gap-6">
        ...
        >
          ...
          <button
            type="submit"
            disabled={
              isGenerating || !productOrService.trim() || !currentPrice.trim() || !costPrice.trim()
            }
            className="w-full flex items-center justify-center gap-2 bg-rose-600 hover:bg-rose-500 disabled:opacity-60 disabled:cursor-not-allowed text-white font-medium py-2.5 rounded-lg transition-colors text-sm"
          >
            {isGenerating ? (
              <>
              ...
              <>
                <TrendingUp className="w-4 h-4" /> Analizar precio
              </>
            )}
          </button>
        </form>
